/* @ts-self-types="./st_dot_toolbox_tokenizer.d.ts" */
 ...
 * @returns {any}
 */
export function st_dot_count_messages_json(model_name, body_json) {
    ...
    const ret = wasm.st_dot_count_messages_json(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function st_dot_encode_text(model_name, text) {
    const ptr0 = passStringToWasm0(model_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.st_dot_encode_text(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function st_dot_get_text_tokens(model_name, body_json) {
    const ptr0 = passStringToWasm0(model_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(body_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.st_dot_get_text_tokens(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function st_dot_get_token_count_async(model_name, messages) {
    const ptr0 = passStringToWasm0(model_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.st_dot_get_token_count_async(ptr0, len0, messages);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {Uint8Array} bundle_tar_gz
 */
export function st_dot_init_tokenizer_provider(provider, bundle_tar_gz) {
    const ptr0 = passStringToWasm0(provider, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(bundle_tar_gz, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.st_dot_init_tokenizer_provider(ptr0, len0, ptr1, len1);
    if (ret[1]) {
 ...
 * @returns {any}
 */
export function st_dot_token_handler_count_async(model_name, messages) {
    const ptr0 = passStringToWasm0(model_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.st_dot_token_handler_count_async(ptr0, len0, messages);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./st_dot_toolbox_tokenizer_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('st_dot_toolbox_tokenizer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
